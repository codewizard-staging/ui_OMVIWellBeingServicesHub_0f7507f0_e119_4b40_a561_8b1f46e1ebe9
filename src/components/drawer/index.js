            ...
            <List>
                <ListItem disablePadding sx={{ display: 'block' }}>
                    <List component="div" disablePadding>
                        <ListItemButton onClick={() => NavigateTo("/info1")} sx={{ height: 50 }}>
                            <ListItemIcon sx={{ minWidth: 30 }}>
                                <Tooltip title="ServiceForm">
                                    <EditNote color="primary" />
                                </Tooltip>
                            </ListItemIcon>
                            {open && <ListItemText primary="ServiceForm" sx={{ pl: 1 }} />}
                        </ListItemButton>
                        <ListItemButton onClick={() => NavigateTo("/services1")} sx={{ height: 50 }}>
                            <ListItemIcon sx={{ minWidth: 30 }}>
                                <Tooltip title="Services">
                                    <Toc color="primary" />
                                </Tooltip>
                            </ListItemIcon>
                            {open && <ListItemText primary="Services" sx={{ pl: 1 }} />}
                        </ListItemButton>
                    </List>
                </ListItem>
            </List>
